...
class TestGrafo(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Grafos testes de Djikstra
        self.grafoDijkstra = MeuGrafo()
        self.grafoDijkstra.adiciona_vertice("A")
        self.grafoDijkstra.adiciona_vertice("B")
        self.grafoDijkstra.adiciona_vertice("C")
        self.grafoDijkstra.adiciona_vertice("D")
        self.grafoDijkstra.adiciona_vertice("E")
        self.grafoDijkstra.adiciona_aresta("a1", 'A', 'B', 4)
        self.grafoDijkstra.adiciona_aresta("a2", 'A', 'C', 2)
        self.grafoDijkstra.adiciona_aresta("a3", 'C', 'B', 1)
        self.grafoDijkstra.adiciona_aresta("a4", 'C', 'D', 5)
        self.grafoDijkstra.adiciona_aresta("a5", 'B', 'D', 3)
        self.grafoDijkstra.adiciona_aresta("a6", 'D', 'E', 2)

        self.grafoDijkstraResposta = MeuGrafo()
        self.grafoDijkstraResposta.adiciona_vertice("A")
        self.grafoDijkstraResposta.adiciona_vertice("B")
        self.grafoDijkstraResposta.adiciona_vertice("C")
        self.grafoDijkstraResposta.adiciona_vertice("D")
        self.grafoDijkstraResposta.adiciona_vertice("E")
        self.grafoDijkstraResposta.adiciona_aresta("a2", 'A', 'C', 2)
        self.grafoDijkstraResposta.adiciona_aresta("a3", 'C', 'B', 1)
        self.grafoDijkstraResposta.adiciona_aresta("a5", 'B', 'D', 3)
        self.grafoDijkstraResposta.adiciona_aresta("a6", 'D', 'E', 2)
    ...
    def test_dijkstra(self):
        self.assertEqual(self.grafoDijkstra.dijkstra('A', 'E'), self.grafoDijkstraResposta)
